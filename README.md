### [7plus](https://github.com/warren-bank/crx-7plus/tree/webmonkey-userscript/es5)

[Userscript](https://github.com/warren-bank/crx-7plus/raw/webmonkey-userscript/es5/webmonkey-userscript/7plus.user.js) to run in:
...
Its purpose is to:
* redirect embedded videos from [7plus.com.au](https://7plus.com.au/) to an external player
